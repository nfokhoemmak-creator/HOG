...
hero_blocks={
 ...
 "sub":text("<p>Satin, lace and knit pieces curated from the UAE for evenings that start late. Sizes XS to 3XL by style, priced in USD.</p>","paragraph",BG,max_width="narrow",**{"padding-block-end":8}),
...
header_blocks={"eyebrow":pl_text("<p>New in</p>","h6"),"heading":pl_text("<h2>Eight to start with.</h2>","h2"),"body":pl_text("<p>Shown in the makers' photographs, at real prices. Dresses from $32, sets from $38. Every size run is on the product page.</p>","paragraph",max_width="narrow"),"cta":{"type":"_product-list-button","settings":{"label":"View all styles","open_in_new_tab":False,"style_class":"button-unstyled","width":"fit-content","custom_width":100,"width_mobile":"fit-content","custom_width_mobile":100},"blocks":{}}}
...
film_blocks={
 ...
 "clips":group({"juliette":clip("j","shopify://files/videos/mareluce-film-juliette.mp4","The Juliette cowl neckline draping as the camera closes in","<p>The Juliette cowl-neck halter maxi, $47, sizes XS to XL.</p>","See the Juliette","shopify://products/swinging-collar-dress"),"nova":clip("n","shopify://files/videos/mareluce-film-nova.mp4","The Nova cable-knit quarter-zip catching the light","<p>The Nova cable-knit quarter-zip, $48, sizes S to XXL, seven colours.</p>","See the Nova","shopify://products/new-trendy-womens-zipper-top")},direction="row",gap=24,valign="flex-start"),
...
# 5 FACTS marquee
facts=["Dresses from $32","Two-piece sets from $38","Sizes XS to 3XL, depending on style","Priced in USD","Ships to 41 countries","Curated from the UAE","Secure Shopify checkout"]
mb={}
...
# 6 STORY
story_ps=["Mareluce began with a question we kept asking each other: what do you wear into that last hour of light, when the day is done and the evening has not decided what it is yet? Most of what we found either cost more than the evening or looked cheaper than it. We wanted the narrow middle: pieces that look the part at a price that does not need an occasion.","Every style is chosen from partner suppliers with that hour in mind: the fall of a satin slip, the way a cowl neck settles, the weight of a wool-blend knit when the evening turns cool. We keep the styles that run from XS to 3XL where the maker offers them, and we list the size run on every product page.","Mareluce is the new name for Jamálati. Same pieces, priced in USD as before, and the same inbox answering your messages. We are based in the UAE, we curate rather than make, and we would rather tell you where an order ships from than let you find out later."]
...
# 7 LOOKS
add("looks",coll_list("looks","Looks",["the-golden-hour-look","satin-and-boots","the-knit-set"],{"eyebrow":text("<p>Looks</p>","h6"),"heading":text("<h2>Three ways to wear the evening.</h2>","h2",max_width="narrow"),"body":text("<p>Full prices, added up on each look page. Pick your sizes there.</p>","paragraph",max_width="narrow")},3,"1",(48,72)))
...
trust_blocks={"t1":trust("lock","Secure Shopify checkout","Payment is handled by Shopify's checkout. We never see your card details."),"t2":trust("truck","Ships to 41 countries","Your shipping rate and delivery window are shown at checkout, before you pay. Orders are fulfilled from partner supplier warehouses."),"t3":trust("ruler","The size run, on every page","Each style lists its own run, from XS to 3XL depending on the piece."),"t4":trust("chat_bubble","A person answers","Not sure between two sizes? <a href=\"/pages/contact\">Email us</a> before you order and we will tell you what we would pick.")}
...
header={"type":"header","name":"Header","sections":{
 "announcements":{"type":"header-announcements","blocks":{"a1":ann("Jamálati is now Mareluce. Same pieces, new name."),"a2":ann("Sizes XS to 3XL, depending on style. Prices in USD."),"a3":ann("Ships to 41 countries. Secure Shopify checkout.")},"block_order":["a1","a2","a3"],"name":"t:names.announcement_bar","settings":{"speed":6,"section_width":"page-width","background_color":INK,"divider_width":0,"padding-block-start":10,"padding-block-end":10}},
