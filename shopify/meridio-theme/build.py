...
# 1 HERO
hero_blocks={
 "eyebrow":text("<p>Meridio. Occasion and holiday dresses.</p>","h6",PEACH,max_width="normal"),
...
card_blocks={"product-card-gallery":{"type":"_product-card-gallery","name":"t:names.product_card_media","settings":{"image_ratio":"portrait","border":"none","border_width":1,"border_opacity":100,"border_radius":0,**PAD0},"blocks":{}},
 ...
 "rating_stars":{"type":"review","settings":{"stars_style":"shaded","show_number":True,"type_preset":"paragraph","width":"100%","alignment":"left"},"blocks":{}},
...
add("collections",coll_list("collections","Shop by collection",["men","dresses","sets","knits-and-trousers","boots-and-accessories"],{"eyebrow":text("<p>Collections</p>","h6"),"heading":text("<h2>Shop by the evening you have in mind.</h2>","h2",max_width="narrow"),"body":text("<p>The men's edit, dresses for the table, sets for the terrace and knits for the walk back. Boots, sunglasses, a ring and a gloss to finish.</p>","paragraph",max_width="narrow")},5,"2",(48,72)))
...
# 6 STORY
story_ps=["Meridio began with a question we kept asking each other: what do you wear into that last hour of light, when the day is done and the evening has not decided what it is yet? Most of what we found either cost more than the evening or looked cheaper than it. We wanted the narrow middle: pieces that look the part at a price that does not need an occasion.","Every style is chosen from partner suppliers with that hour in mind: the fall of a satin slip, the way a cowl neck settles, the weight of a wool-blend knit when the evening turns cool. We keep the pieces that earn their place, and we list the size run and measurements on every product page.","Meridio is the new name for Jamálati. Same pieces, same inbox answering your messages. We curate rather than make, and we would rather tell you where an order ships from than let you find out later."]
story_blocks={"image":{"type":"image","settings":{"image":"shopify://shop_images/mareluce-hero-juliette-poster.png","link":"shopify://products/swinging-collar-dress","image_ratio":"portrait","width":"fill","custom_width":100,"width_mobile":"fill","custom_width_mobile":100,"height":"fit","border":"none","border_width":1,"border_opacity":100,"border_radius":4,**PAD0},"blocks":{}},
 "copy":group({"eyebrow":text("<p>Our story</p>","h6"),"heading":text("<h2>We started with the hour, not the dress.</h2>","h2",max_width="narrow"),"p1":text(f"<p>{story_ps[0]}</p>","paragraph",max_width="narrow"),"p2":text(f"<p>{story_ps[1]}</p>","paragraph",max_width="narrow"),"p3":text(f"<p>{story_ps[2]}</p>","paragraph",max_width="narrow"),"sign":text("<p>The Meridio team</p>","h6",SOFT),"cta":button("Read our story","/pages/our-story","button-secondary")},gap=14,valign="center")}
...
header={"type":"header","name":"Header","sections":{
 "announcements":{"type":"header-announcements","blocks":{"a1":ann("Jamálati is now Meridio. Same pieces, new name."),"a2":ann("Free shipping on orders over $120."),"a3":ann("Ships to 41 countries. Secure Shopify checkout.")},"block_order":["a1","a2","a3"],"name":"t:names.announcement_bar","settings":{"speed":6,"section_width":"page-width","background_color":INK,"divider_width":0,"padding-block-start":10,"padding-block-end":10}},
...
footer_blocks={"cols":group({
 "brand":group({"logo":{"type":"logo","settings":{"inverse":True,"font":"heading","unit":"pixel","percent_width":100,"pixel_height":26,"custom_mobile_size":False,"unit_mobile":"pixel","percent_width_mobile":100,"pixel_height_mobile":26,**PAD0},"blocks":{}},"line":text("<p>Meridio, formerly Jamálati, is an online clothing brand for women and men. We curate occasion and holiday pieces from partner suppliers and answer every message ourselves, by email.</p>","paragraph",PEACH,max_width="narrow")},gap=16),
...
# SETTINGS DATA
cur={"logo":"shopify://shop_images/meridio-logo-ink.png","logo_inverse":"shopify://shop_images/meridio-logo-cream.png","logo_height":30,"logo_height_mobile":24,"favicon":"shopify://shop_images/mareluce-monogram.png",
...
settings={"current":cur,"presets":{"Meridio":cur}}
